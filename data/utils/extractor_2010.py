...
def build_info():
    return {
        ...
        'fourth_students': 0,
        'fourth_classes': 0,
        'continuous_teachers': 0,
        'continuous_masters': 0,
        'continuous_doctors': 0,
        'continuous_students': 0,
...
def process_schools_2010(filename):
    print(filename)
    schools = {}
...
def process_classes_2010(filename, schools):
    print(filename)
    seen = {}
    with open(filename, "r+b") as file:
        reader = csv.DictReader(mmap_csv(file), delimiter='|')
        for i, line in enumerate(reader):
            ...
            if line['FK_COD_ETAPA_ENSINO'] in ['29', '34']:
                school['continuous_classes'] += 1

def process_enrollments_2010(filenames, schools):
        ...
        with open(filename, 'r+b') as file:
            ...
            for i, line in enumerate(reader):
                ...
                if step not in seen[school_code][student_code]:
                    ...
                    if step in ['29', '34'] and len(set(['29', '34']) & seen[school_code][student_code]) == 0:
                        school['continuous_students'] += 1

                    seen[school_code][student_code].add(step)

def process_teachers_2010(filenames, schools):
    for filename in filenames:
        print(filename)
        seen = {}
        with open(filename, 'r+b') as file:
            ...
            for i, line in enumerate(reader):
                ...
                if step not in seen[school_code][teacher_code]:
                    ...
                    if step in ['29', '34'] and len(set(['29', '34']) & seen[school_code][teacher_code]) == 0:
                        school['continuous_teachers'] += 1

                        if line['ID_DOUTORADO'] == '1':
                            school['continuous_doctors'] += 1

                        if line['ID_MESTRADO'] == '1':
                            school['continuous_masters'] += 1

                    seen[school_code][teacher_code].add(step)

def write_schools(schools):
    print("Writing")
    with open('school_statistics_2010.csv', 'w') as file:
        writer = csv.DictWriter(file, list(build_info().keys()))
        writer.writeheader()
        for school in schools.values():
            writer.writerow(school)

schools = process_schools_2010('../Downloads/2010/DADOS/ESCOLAS.CSV')
process_teachers_2010(
    [
        '../Downloads/2010/DADOS/DOCENTES_CO.CSV',
        '../Downloads/2010/DADOS/DOCENTES_SUL.CSV',
        '../Downloads/2010/DADOS/DOCENTES_SUDESTE.CSV',
        '../Downloads/2010/DADOS/DOCENTES_NORDESTE.CSV',
        '../Downloads/2010/DADOS/DOCENTES_NORTE.CSV'
    ],
    schools
)
process_classes_2010('../Downloads/2010/DADOS/TURMAS.CSV', schools)
process_enrollments_2010(
    [
        '../Downloads/2010/DADOS/MATRICULA_CO.CSV',
        '../Downloads/2010/DADOS/MATRICULA_SUL.CSV',
        '../Downloads/2010/DADOS/MATRICULA_SUDESTE.CSV',
        '../Downloads/2010/DADOS/MATRICULA_NORDESTE.CSV',
        '../Downloads/2010/DADOS/MATRICULA_NORTE.CSV'
    ],
    schools
)
