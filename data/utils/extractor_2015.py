...
def process_schools_2015(filename):
    print(filename)
    schools = {}
...
def process_classes_2015(filename, schools):
    print(filename)
    seen = {}
    with open(filename, "r+b") as file:
        reader = csv.DictReader(mmap_csv(file), delimiter='|')
...
def process_enrollments_2015(filenames, schools):
...
def process_teachers_2015(filenames, schools):
    for filename in filenames:
        print(filename)
        seen = {}
        with open(filename, 'r+b') as file:
...
def write_schools(schools):
    print("Writing")
    with open('school_statistics_2015.csv', 'w') as file:
        writer = csv.DictWriter(file, list(build_info().keys()))
        writer.writeheader()
        for school in schools.values():
            writer.writerow(school)

schools = process_schools_2015('../Downloads/2015/DADOS/ESCOLAS.CSV')
process_teachers_2015(
    [
        '../Downloads/2015/DADOS/DOCENTES_CO.CSV',
        '../Downloads/2015/DADOS/DOCENTES_SUL.CSV',
        '../Downloads/2015/DADOS/DOCENTES_SUDESTE.CSV',
        '../Downloads/2015/DADOS/DOCENTES_NORDESTE.CSV',
        '../Downloads/2015/DADOS/DOCENTES_NORTE.CSV'
    ],
    schools
)
process_classes_2015('../Downloads/2015/DADOS/TURMAS.CSV', schools)
process_enrollments_2015(
    [
        '../Downloads/2015/DADOS/MATRICULA_CO.CSV',
        '../Downloads/2015/DADOS/MATRICULA_SUL.CSV',
        '../Downloads/2015/DADOS/MATRICULA_SUDESTE.CSV',
        '../Downloads/2015/DADOS/MATRICULA_NORDESTE.CSV',
        '../Downloads/2015/DADOS/MATRICULA_NORTE.CSV'
    ],
    schools
)
